...
void MX_HRTIM1_Init(void)
{
  ...
  if (HAL_HRTIM_DLLCalibrationStart(&hhrtim1, HRTIM_SINGLE_CALIBRATION) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  pTimerCfg.ResetTrigger = HRTIM_TIMRESETTRIGGER_EEV_4;
  ...
  pTimeBaseCfg.RepetitionCounter = 255;
  pTimeBaseCfg.PrescalerRatio = HRTIM_PRESCALERRATIO_MUL32;
...
void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspInit 0 */
    ...
    PB6     ------> HRTIM1_EEV4
    */
    GPIO_InitStruct.Pin = ASK_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_HRTIM1;
    HAL_GPIO_Init(ASK_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_HRTIM_MspPostInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspPostInit 0 */
    ...
    PB13     ------> HRTIM1_CHC2
    */
    GPIO_InitStruct.Pin = R_BRIDGE_Pin|L_BRIDGE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_HRTIM_MspDeInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspDeInit 0 */
    ...
    PB6     ------> HRTIM1_EEV4
    */
    HAL_GPIO_DeInit(GPIOB, R_BRIDGE_Pin|L_BRIDGE_Pin|ASK_OUT_Pin);
